...
3. **NoLiMa 데이터셋 품질 검증 필요**: 규칙 기반 생성이 너무 쉬웠을 가능성
...
| 항목 | RAG | Gist Token | LoRA (예상) |
|------|-----|------------|-------------|
| **NoLiMa 정확도** | **94.5%** | 41.5% | 60-70% |
| **Retrieval Recall** | 100% | N/A | N/A |
| **압축률** | N/A (청킹) | 152배 | N/A |
| **메모리 효율** | 좋음 | **최고** | 보통 |
| **전역 문맥 이해** | ❌ 청크 단위 | ✅ 압축 유지 | ✅ 가중치 내재 |
| **데이터 업데이트** | ✅ 즉시 | ✅ 즉시 | ❌ 재학습 필요 |
| **구현 복잡도** | 낮음 | 중간 | 중간 |
